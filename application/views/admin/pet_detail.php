    ...
    <section class="content">
      ...
      <div class="row">
          ...
          <div class="modal fade" id="changeProfile">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <form action="<?php echo site_url()?>pet_management/update_profile_pet" method="POST" enctype="multipart/form-data">
                      <div class="modal-body">
       ...
       <?php endforeach;?>
         ...
         <div class="col-md-9">
            <?php $this->load->view('include_pages_admin/pet_detail_tab_panel');?>
         </div>
