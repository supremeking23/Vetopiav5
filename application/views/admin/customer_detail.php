    ...
    <section class="content">
      ...
      <div class="row">
         ...
         <div class="modal fade" id="changeProfile">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <form action="<?php echo site_url()?>user_management/update_profile_customer" method="POST" enctype="multipart/form-data">
       ...
       <?php endforeach;?>
         ...
         <div class="col-md-9">
            <?php $this->load->view('include_pages_admin/customer_detail_tab_panel');?>
         </div>
