    ...
    <section class="content">
      ...
      <div class="row">
          <div class="col-md-12">
             ...
             <?php if ($this->session->flashdata('update_staff_success')) { ?>

                <div class="alert alert-success display-success">
                  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                    <p> <?php echo $this->session->flashdata('update_staff_success'); ?> </p>
                </div>
             ...
             <div class="box box-primary">
                  <div class="box-body box-profile">
                      <a href="" data-toggle="modal" data-target="#changeProfile">
                         ...
                         <?php if(empty($s_details->profile)){ //guest2?>
                          ...
                          <?php }else{ ?>
                                <img class="profile-user-img img-responsive img-circle" src="<?php echo site_url()?>assets/images/profiles/<?php echo $s_details->profile; ?>" alt="User's Name">
                          <?php } ?>


                      </a>

                      <h3 class="profile-username text-center"><?php echo $s_details->firstname .' '. $s_details->middlename .' '.$s_details->lastname;?></h3>

                      <p class="text-muted text-center"><?php echo $s_details->staff_id?></p>

                      <ul class="list-group list-group-unbordered">
                        <li class="list-group-item">
                          <?php $age = floor((time() - strtotime($s_details->birthdate)) / 31556926);?>
                        ...
                        <li class="list-group-item">
                          <b>Member Since</b> <a class="pull-right"><?php  
                              ...
                              $date =date_create($s_details->dateAdded);
          ...
          <div class="modal fade" id="changeProfile">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <form action="<?php echo site_url()?>user_management/update_profile_staff" method="POST" enctype="multipart/form-data">
       ...
       <?php endforeach;?>
         ...
         <div class="col-md-9">
            <?php $this->load->view('include_pages_admin/staff_detail_tab_panel');?>
         </div>
