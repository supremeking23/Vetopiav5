...
<body class="hold-transition <?php echo $skin_color;?> sidebar-mini" id="inventory">
<div class="wrapper">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-solid <?php echo $box_color; ?>">
            ...
            <div class="box-body table-responsive">
              ...
              <table  class="datatableinv table table-bordered table-striped">
                <thead>
                <tr>
                  <th>Date</th>
                  <th>Product Name</th>
                ...
                <?php foreach($all_inventory as $inventory):?>
                  <tr>
                    <td>
                      <?php 

                             $date =date_create($inventory->inventory_date);
                             echo  $log_date_format= date_format($date,"F d, Y h:i:sa");
                           ;?>
                     </td>
                    <td><?php echo $inventory->product_name;?></td>
                    <td><?php echo $inventory->productType;?></td>
                    
                    <td><?php echo $inventory->user_name ?> (<?php echo $inventory->user_type ?>)</td>
