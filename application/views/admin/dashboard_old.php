  ...
  <div class="content-wrapper">
    ...
    <section class="content">
                    ...
                    <div class="box box-solid <?php echo $box_color?>">
                      <div class="box-header with-border">
                        ...
                        <div class="box-body chart-responsive">
                          <div class="chart" id="line-chart-sales-day" style="height: 300px;"></div>
                        </div>
                        <!-- /.box-body -->
                    </div>
                    <!-- /.box -->
       ...
       <div class="col-md-12">
                    ...
                    <div class="box box-solid <?php echo $box_color?>">
                      <div class="box-header with-border">
                        ...
                        <div class="box-body chart-responsive">
                          <div class="chart" id="line-chart-sales-month" style="height: 300px;"></div>
                        </div>
                        <!-- /.box-body -->
                    </div>
                    <!-- /.box -->
      ...
      <div class="row">
       <div class="col-md-12">
                     <!-- LINE CHART -->
                    <div class="box box-solid <?php echo $box_color?> collapsed-box">
                      <div class="box-header with-border">
                        ...
                        <div class="box-body chart-responsive">
                          <div class="chart" id="line-chart-sales-year" style="height: 300px;"></div>
                        </div>
                        <!-- /.box-body -->
                    </div>
                    <!-- /.box -->
...
$connect = mysqli_connect("localhost", "root", "", "vetopia_db");
$query2 = "SELECT date(sales_date) as sales_M,SUM(total_amount) AS 'total_am' FROM tbl_sales group by MONTH(sales_date);";
...
$connect = mysqli_connect("localhost", "root", "", "vetopia_db");
$query4 = "SELECT date(sales_date) as sales_Y,SUM(total_amount) AS 'total_am' FROM tbl_sales group by YEAR(sales_date);";
