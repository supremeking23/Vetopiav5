  <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                  <div class="active tab-pane" id="settings">
                    <form class="form-horizontal" action="<?php echo site_url()?>user_management/update_staff_details" method="POST">
                    ...
                    <?php foreach($staff_details as $s_details):?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" value="<?php echo $s_details->staff_id;?>" name="staff_id" id="staff_id" placeholder="Staff_id" readonly="" style="border-radius: 15px">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" value="<?php echo $s_details->firstname;?>" name="firstname" placeholder="First Name" style="border-radius: 15px">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" value="<?php echo $s_details->middlename;?>" name="middlename" placeholder="Middle Name" style="border-radius: 15px">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" value="<?php echo $s_details->lastname;?>" name="lastname" placeholder="Last Name" style="border-radius: 15px">
                        </div>
                      </div>
                      ...
                      <?php //parameters(attribute name , options,selected option,added attibute ex:class,required)?>
                             <?php echo form_dropdown('gender',$option,$s_details->gender,'class="form-control" required style="border-radius: 15px"');?>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="date" class="form-control" value="<?php echo $s_details->birthdate;?>" name="birthdate" style="border-radius: 15px">
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" value="<?php echo $s_details->contact;?>" name="contact" placeholder="Contact Number" style="border-radius: 15px">
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="email" class="form-control" value="<?php echo $s_details->email;?>" name="email" placeholder="Email" style="border-radius: 15px">
                        </div>
                      </div> 
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" value="<?php echo $s_details->homeAddress;?>" name="homeAddress" placeholder="Home Address" style="border-radius: 15px">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" value="<?php echo $s_details->barangayAddress;?>" name="barangayAddress"  placeholder="Barangay Address" style="border-radius: 15px">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" value="<?php echo $s_details->cityAddress;?>" name="cityAddress" placeholder="City Address" style="border-radius: 15px">
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" value="<?php echo $s_details->postalID;?>" name="postalID" placeholder="Zip Code"style="border-radius: 15px">
                        </div>
                      </div>
                      ...
                      <input type="hidden" name="user_id_update" value="<?php echo $s_details->staff_table_id;?>">
  ...
  $(function(){
    ...
    $('.datatablelogstaff').DataTable( {
        ...
        buttons: [
            {
              extend: 'pdfHtml5',
              title: 'Log Report for Staff: <?php echo $logs->log_user;?>' ,
