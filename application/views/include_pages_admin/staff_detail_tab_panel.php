                ...
                <div class="tab-content">
                  <div class="active tab-pane" id="settings">
                    ...
                    <?php foreach($staff_details as $s_details):?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" value="<?php echo $s_details->firstname;?>" name="firstname" placeholder="First Name">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" value="<?php echo $s_details->middlename;?>" name="middlename" placeholder="Middle Name">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" value="<?php echo $s_details->lastname;?>" name="lastname" placeholder="Last Name">
                        </div>
                      </div>
                      ...
                      <?php //parameters(attribute name , options,selected option,added attibute ex:class,required)?>
                             <?php echo form_dropdown('gender',$option,$s_details->gender,'class="form-control" required');?>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="date" class="form-control" value="<?php echo $s_details->birthdate;?>" name="birthdate" >
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" value="<?php echo $s_details->homeAddress;?>" name="homeAddress" placeholder="Home Address">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" value="<?php echo $s_details->barangayAddress;?>" name="barangayAddress"  placeholder="Barangay Address">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" value="<?php echo $s_details->cityAddress;?>" name="cityAddress" placeholder="City Address">
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" value="<?php echo $s_details->postalID;?>" name="postalID" placeholder="Postal ID">
                        </div>
                      </div>
                  ...
                  <!-- /.tab-pane -->
                   <div class=" tab-pane" id="logHistory">
                    <table  class="datatablelogstaff table table-bordered table-striped">
                          <thead>
                          <tr>
                            <th>Log Date</th>
