                  ...
                  <div class="active tab-pane" id="settings">
                    ...
                    <?php foreach($customer_details as $c_details):?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" id="username" class="form-control" value="<?php echo $c_details->username;?>" name="username" placeholder="Username">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="password" id="password" class="form-control " value="<?php echo $c_details->password;?>" name="password" placeholder="Password">
