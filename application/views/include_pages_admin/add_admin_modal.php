                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                          <div class="col-md-12">
                              ...
                              <input type="text" name="admin_id" id="admin_id" class="form-control" readonly="" style="border-radius: 15px">
                         </div>   
                    </div>
                   ...
                   <br />
                    ...
                    <div class="row">
                          <div class="col-md-12">
                              ...
                              <input type="date" class="form-control"  value="" name="birthdate" required="" id="max_date" style="border-radius: 15px">
