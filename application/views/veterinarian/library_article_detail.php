        ...
        <div class="row">
          <div class="col-md-8">    
              <div class="box box-default">
                <div class="box-header is_editable_edit">
                ...
                <div class="box-body">
                   ...
                   <p><?php echo $fac->article_contents?>
                     <button type="button" class="btn btn-success btn-sm btn-flat is_editable_edit" data-toggle="modal" data-target="#changeContent<?php echo $fac->content_id?>" data-tooltip="tooltip" data-title="Change Content"><i class="fa fa-pencil"></i></button> <span class="is_editable_edit">|</span> <button type="button" class="btn btn-danger btn-sm btn-flat is_editable_edit" data-toggle="modal" data-tooltip="tooltip" data-title="Delete Content" data-target="#remove_content<?php echo $fac->content_id;?>"><i class="fa fa-trash"></i></button>
                   </p>
          ...
          <div class="col-md-4">
              ...
              <div class="box box-default">
                <div class="box-body">
                  ...
                  <h3 class="text-center">Related Article <button type="button" class="btn btn-sm btn-flat btn-default is_editable_edit" data-tooltip="tooltip" data-title="Add Related Article" data-toggle="modal" data-target="#addRelatedArticle"><i class="fa fa-plus"></i></button></h3>
                     ...
                     <ul class="list-unstyled">
                        <?php foreach($find_related_article as $related):?>
                         <li><a href="<?php echo site_url()?>Veterinarian/Library_article_detail/<?php echo $related->related_library_id;?>"  target="_blank" style="text-decoration: underline;"><?php echo $related->title;?></a></li>
          ...
          <div class="col-md-8">
             ...
             <div class="box box-default">
                <div class="box-header">
                    ...
                    <!-- tools box -->
                    <div class="pull-right box-tools is_editable_edit">
                ...
                <div class="box-body">
                  <?php foreach($find_article_links as $fal):?>
                      <p><a href="<?php echo $fal->web_link?>"><?php echo $fal->web_link?></a><button type="button" class="btn btn-danger btn-sm btn-flat is_editable_edit" data-toggle="modal" data-target="#remove_link<?php echo $fal->links_id?>"><i class="fa fa-trash"></i></button></p>
...
<script>
  ...
  function show_editable(){
     /* $('.editable-content_edit').css('display', '');
      $('.editable-content_add').css('display', '');
      $('.is_editable_edit').css('display', ''); 
      $('.is_editable_remove').css('display', '');  */
      $('.is_editable_edit').css('display', ''); 
  }


  function hide_editable(){
    /* $('.editable-content_edit').css('display', 'none');
      $('.editable-content_add').css('display', 'none');  
      $('.is_editable_edit').css('display', 'none');   
      $('.is_editable_remove').css('display', 'none');   */
      $('.is_editable_edit').css('display', 'none');
  }

  function check_is_editable(){
    var editable = $('#is_editable').val();
    if(editable == 1){
        show_editable();
        //alert('sayo to');
    }else{
