...
<head>
  ...
  <title><?php echo $title?> | Medical Record</title>
    ...
    <div class="row invoice-info">
      ...
      ?>
        ...
        <?php foreach($get_prescription_by_appointment_table_id as $prescription):?>
          <div class="row">
            <div class="col-md-12">
              <label style="margin-left: 15px">Subjective : </label> 
              <div class="form-group">
               <div style="margin-left: 15px"><?php echo $prescription->subjective; ?></div>
              </div>
            </div>
          </div>
           <hr />
          <div class="row">
            <div class="col-md-12">
              <label style="margin-left: 15px">Objective : </label> 
              <div class="form-group">
               <div style="margin-left: 15px"><?php echo $prescription->objective; ?></div>
              </div>
            </div>
          </div>
           <hr />
          <div class="row">
            <div class="col-md-12">
              <label style="margin-left: 15px">Assessment : </label> 
              <div class="form-group">
               <div style="margin-left: 15px"><?php echo $prescription->assessment; ?></div>
              </div>
            </div>
          </div>
           <hr />
          <div class="row">
            <div class="col-md-12">
              <label style="margin-left: 15px">Plan : </label> 
              <div class="form-group">
               <div style="margin-left: 15px"><?php echo $prescription->plan; ?></div>
              </div>
            </div>
          </div>
           <hr />
