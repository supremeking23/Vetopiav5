...
<div class="wrapper">
  ...
  <div class="content-wrapper">
   ...
   <?php if ($this->session->flashdata('update_staff_password')) { ?>

      <div class="alert alert-success display-success">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
          <p> <?php echo $this->session->flashdata('update_staff_password'); ?> </p>
      </div>
    ...
    <?php if ($this->session->flashdata('update_staff_password_mismatched')) { ?>

      <div class="alert alert-danger display-danger">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
          <p> <?php echo $this->session->flashdata('update_staff_password_mismatched'); ?> </p>
      </div>

     <?php }?>


    <?php if ($this->session->flashdata('update_staff_password_failed')) { ?>

      <div class="alert alert-danger display-danger">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
          <p> <?php echo $this->session->flashdata('update_staff_password_failed'); ?> </p>
      </div>
        ...
        <div class="col-md-12">
          <div class="box box-solid <?php echo $box_color;?>">
            ...
            <div class="box-body ">
              ...
              <?php echo form_open_multipart('user_management/change_password_staff','id="change_password"');?>
